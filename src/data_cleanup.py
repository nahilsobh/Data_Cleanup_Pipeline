...
SELECT = { "samples_clustering_pipeline"      : "run_samples_clustering_pipeline",
...
def run_pipelines(run_parameters, method):
    ...
    logger.generate_logging(validation_flag, message, results_directory + "/log_" + pipeline_type + ".yml")
...
def data_cleanup():
    try:
        ...
        pipeline_type           = run_parameters['pipeline_type'] 
        run_pipelines(run_parameters, SELECT[pipeline_type])
