...
class Pipelines:
    ...
    def run_geneset_characterization_pipeline(self):
        ...
        if self.user_spreadsheet_df is None: return False, logger.logging
        ...
        if user_spreadsheet_val_chked is None: return False, logger.logging
        ...
        if user_spreadsheet_df_cleaned is None: return False, logger.logging
        ...
        logger.logging.append("INFO: Cleaned user spreadsheet has {} row(s), {} column(s).".format(
    ...
    def run_simplified_inpherno_pipeline(self):
        ...
        IOUtil.write_to_file(self.Pvalue_gene_phenotype, self.run_parameters['Pvalue_gene_phenotype_full_path'], self.run_parameters['results_directory'], "_ETL.tsv")
        IOUtil.write_to_file(self.Pvalue_gene_phenotype, self.run_parameters['expression_sample_full_path'],     self.run_parameters['results_directory'], "_ETL.tsv")
        IOUtil.write_to_file(self.Pvalue_gene_phenotype, self.run_parameters['TFexpression_full_path'],          self.run_parameters['results_directory'], "_ETL.tsv", use_header=False)
        return True, logger.logging
